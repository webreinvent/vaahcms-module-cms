        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button
                    ...
                    data-testid="menus-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="menus-actions-bulk-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="menus-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    data-testid="menus-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                data-testid="menus-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="menus-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
