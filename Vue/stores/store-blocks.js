...
let model_namespace = 'VaahCms\Modules\Cms\\Models\\Block';
...
export const useBlockStore = defineStore({
    ...
    actions: {
        ...
        toForm()
        {
            this.item = vaah().clone(this.assets.empty_item);
            this.getFormMenu();
            this.$router.push({name: 'blocks.form'})
        },
        //---------------------------------------------------------------------
        toView(item)
        {
        ...
        {
            this.item = item;
            this.$router.push({name: 'blocks.form', params:{id:item.id}})
        },
        //---------------------------------------------------------------------
        isViewLarge()
        {
