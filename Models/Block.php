...
class Block extends BlockBase
{
    ...
    public static function createItem($request)
    {
        ...
        $sort_number_exist = static::where('vh_theme_id',$inputs['vh_theme_id'])
            ->where('vh_theme_location_id',$inputs['vh_theme_location_id'])
            ->where('sort',$inputs['sort'])
            ->first();

        if($sort_number_exist)
        {
            $response['success'] = false;
            $response['messages'][] = "Select different sort number.";
            return $response;
        }
    ...
    public static function getList($request)
    {
        ...
        $list = $list->with([ 'themeLocation','theme'])->paginate($rows);
